...
function pre_install(){
    ...
    echo -e "感谢使用 “\033[35m xygeng \033[0m” \033[32m [多端口版] \033[0m 一键SSR翻墙加速脚本【已支持国内一键安装】"
    
    
    read -p "(回车将默认设置连接密码为：blog.xygeng.cn):" diosssrpwd
    ...
    while true
    do
            read -p "(④端口回车默认设置远程连接端口为: 443 ):" diosssrport4
    [ -z "$diosssrport4" ] && diosssrport4="443"
