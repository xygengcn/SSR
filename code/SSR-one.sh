...
function pre_install(){
    ...
    echo 
    read -p "(回车将默认设置连接密码为：blog.xygeng.cn):" shadowsockspwd
    [ -z "$shadowsockspwd" ] && shadowsockspwd="blog.xygeng.cn"
    echo
    echo "---------------------------"
    ...
    echo
    echo "安装前的准备已就绪按下Ctrl+C取消安装或任意键开始安装！"
    char=`get_char`
